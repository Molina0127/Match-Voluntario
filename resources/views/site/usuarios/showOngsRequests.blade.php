                    ...
                    <div class="tab-pane fade show active" id="unemployment" role="tabpanel" aria-labelledby="unemployment-tab" tabindex="0">
                        ...
                        <div class="row justify-content-center">
                                ...
                                <div class="courses-item">
                                    <a href="#" class="link">
                                        <div class="courses-item-inner">
                                                ...
                                                $check = DB::table('adiciona_usuarios')
                                                ->where('status',1)->get();
                                                if($check == true){
                                            ...
                                            <div class="img-box">
                                                ...
                                                @else
                                                <img src="{{ asset($showVol->ong_image) }}" alt="{{$showVol->ong_image}}" style="width: 205px; height: 205px;">
                                                @endif
                                            </div>
                                            ...
                                            <br>
                                                ...
                                                <a href="#inviteOng{{$showVol->id}}" data-bs-toggle="modal" class="btn btn-primary" style="color:white;">
                                                    Aceitar pedido   
                                                    </a>
                                                    @include('site.usuarios.accept')

                                                    <br>

                                                <a href="#declineOng{{$showVol->id}}" data-bs-toggle="modal" class="btn btn-danger" style="color:white;">
                                                    Recusar pedido   
                                                    </a>
                                                    @include('site.usuarios.decline')
                            ...
                            <div class="section-title text-center">
                                <p class="sub-title">Nenhum pedido pendente</p>
                            </div>
                            @endif
                            <!-- courses item end -->
