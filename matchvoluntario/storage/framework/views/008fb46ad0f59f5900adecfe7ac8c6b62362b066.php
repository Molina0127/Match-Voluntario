                        ...
                        <div class="banner-img">
                            <div class="circular-img">
                                <div class="circular-img-inner">
                                    ...
                                    <img src="<?php echo e(Vite::asset('resources/img/Foto-banner-removebg-preview-reduced-200.png')); ?>" alt="Banner Image">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-center mt-3">
                        <a href="<?php echo e(route('ongs')); ?>" class="btn btn-theme">Veja Todas as Ongs</a>
                    </div>
                </div>
        ...
        <!-- testemunhos section start -->
            <div class="testimonials-section section-padding position-relative">
                ...
                <div class="decoration-imgs">
                    ...
                    <img src="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular2.png')); ?>" alt="" class="decoration-imgs-item">
                    <img src="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular2.png')); ?>" alt="" class="decoration-imgs-item">
                    <img src="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular2.png')); ?>" alt="" class="decoration-imgs-item">
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6">
                            <div class="img-box rounded-circle position-relative">
                                <img src="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular2.png')); ?>" class="w-100 js-testimonial-img-rounded-circle" alt="Imagem de Testemunho">
                            </div>

                            <div id="carouselOne" class="carousel slide text-center" data-bs-ride="carousel">
                                <div class="carousel-inner mb-4">
                                    <div class="carousel-item active" data-js-testimonial-img="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular.png')); ?>">
                                    ...
                                    <div class="carousel-item" data-js-testimonial-img="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular2.png')); ?>">
                                        <div class="testimonials-item">
                                                <p class="text-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, 
                                                sed consequuntur maiores deserunt dolores atque minima temporibus numquam. 
                                                Voluptatibus, neque!</p>
                                    ...
                                    <div class="carousel-item" data-js-testimonial-img="<?php echo e(Vite::asset('resources/img/Foto-de-perfil-linkedin-recortada.jpeg')); ?>">
                                        <div class="testimonials-item">
                                            <p class="text-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, 
                                            sed consequuntur maiores deserunt dolores atque minima temporibus numquam. 
                                            Voluptatibus, neque!</p>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <div class="circular-img">
                                            <div class="circular-img-inner">
                                                <div class="circular-img-circle"></div>
                                                <img src="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular2.png')); ?>" alt="bai img">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <a href="<?php echo e(route('signup')); ?>" class="btn btn-theme">Inscreva-se</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</html><?php /**PATH D:\Desktop\Match Voluntario\matchvoluntario\resources\views/site/home.blade.php ENDPATH**/ ?>