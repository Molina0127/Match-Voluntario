        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('ongs')); ?>">Ongs</a></li>
                                ...
                                <div class="instructor-details">
                                    <div class="details-wrap d-flex align-items-center flex-wrap">
                                        <div class="left-box me-4">
                                            <div class="img-box">
                                                <img src="<?php echo e(Vite::asset('resources/img/Foto-de-perfil-linkedin-recortada.jpeg')); ?>" class="rounded-circle" alt="owner img">
                                            </div>
                                        </div>
                                        <div class="right-box">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="course-sidebar box">
                        <div class="img-box position-relative" data-bs-toggle="modal" data-bs-target="#video-modal">
                            <img src="<?php echo e(Vite::asset('resources/img/Foto-com-fundo-removido-quadrangular.png')); ?>" class="w-100" alt="ong image">
                            <div class="play-icon">
                ...
                <div class="modal-body">
                    ...
                    <div class="ratio ratio-16x9">
                        <video controls class="js-course-preview-video">
                            <source src= "<?php echo e(Vite::asset('resources/video/video.mp4')); ?>" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH D:\Desktop\Match Voluntario\matchvoluntario\resources\views/site/ongs/ongs_details.blade.php ENDPATH**/ ?>